...
#
#  For example
#  https://raw.githubusercontent.com/jfoxva/azure-vmss-updates/master/LogAnalyticsMonitoring.sh | bash -s "00000000-0000-0000-0000-000000000000"  "Resource Group Name of AKS-Engine cluster"  "/subscriptions/<SubscriptionId>/resourceGroups/<resourceGroup>/providers/Microsoft.OperationalInsights/workspaces/<workspaceName>" "clusterName of AKS-Engine cluster"
#
